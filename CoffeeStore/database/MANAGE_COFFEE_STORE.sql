...
INSERT INTO BILL VALUES ('SP001', '2022/04/16', 0, 0, 0, 1, 'SF002');

DELETE FROM BILL WHERE BILL_ID = 'SP001';

INSERT INTO DETAIL_BILL VALUES ('SP0011', 'SP001', 'TE001', 1, 30000, 'S', 'COLD', 2);
INSERT INTO DETAIL_BILL VALUES ('SP0012', 'SP001', 'TE002', 2, 57000, 'S', 'COLD', 3);

DELETE FROM DETAIL_BILL WHERE DETAIL_BILL_ID = 'SP0011';
UPDATE DETAIL_BILL SET UNIT_PRICE = 90000 WHERE DETAIL_BILL_ID = 'SP0012';

INSERT INTO DETAILBILL_TOPPING VALUES ('SP0011', 'TP001', 3, 18000);
INSERT INTO DETAILBILL_TOPPING VALUES ('SP0011', 'TP002', 2, 16000);

UPDATE DETAILBILL_TOPPING SET PRICE = 18000 WHERE DETAIL_BILL_ID = 'SP0011' AND TOPPING_ID = 'TP001';

DELETE FROM DETAILBILL_TOPPING WHERE DETAIL_BILL_ID = 'SP0011' AND TOPPING_ID = 'TP001';

INSERT INTO SPOT_BILL VALUES ('SP001', 'TB001');
...
BEGIN
	UPDATE BILL
	SET BILL_TOTAL = BILL_TOTAL + (SELECT I.UNIT_PRICE  FROM INSERTED AS I)
	WHERE BILL_ID = (SELECT I.BILL_ID  FROM INSERTED AS I);
END;
...
BEGIN
	UPDATE BILL
	SET BILL_TOTAL = BILL_TOTAL - (SELECT D.UNIT_PRICE FROM DELETED AS D)
	WHERE BILL_ID = (SELECT D.BILL_ID FROM DELETED AS D);
END;
...
BEGIN
	UPDATE BILL
	SET BILL_TOTAL = BILL_TOTAL - (SELECT D.UNIT_PRICE FROM DELETED AS D) + (SELECT I.UNIT_PRICE FROM INSERTED AS I)
	WHERE BILL_ID = (SELECT D.BILL_ID FROM DELETED AS D);
END;
...
BEGIN
	UPDATE DETAIL_BILL
	SET UNIT_PRICE = UNIT_PRICE + (SELECT I.PRICE FROM INSERTED AS I)
	WHERE DETAIL_BILL_ID = (SELECT I.DETAIL_BILL_ID FROM INSERTED AS I);
END;
...
BEGIN
	UPDATE DETAIL_BILL
	SET UNIT_PRICE = UNIT_PRICE - (SELECT D.PRICE FROM DELETED AS D)
	WHERE DETAIL_BILL_ID = (SELECT D.DETAIL_BILL_ID FROM DELETED AS D);
END;
...
BEGIN
	UPDATE DETAIL_BILL
	SET UNIT_PRICE = UNIT_PRICE - (SELECT D.PRICE FROM DELETED AS D) + (SELECT I.PRICE FROM INSERTED AS I)
	WHERE DETAIL_BILL_ID = (SELECT D.DETAIL_BILL_ID FROM DELETED AS D);
END;
