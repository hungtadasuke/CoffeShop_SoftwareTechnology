...
CREATE PROCEDURE INSERT_BILL @BILL_ID CHAR(7), @BILL_DATE DATETIME, @BILL_TOTAL MONEY, @RECEIVED MONEY, @EXCESS MONEY, @BILL_STATUS BIT, @STAFF_ID CHAR(5), @BILL_TYPE VARCHAR(10)
AS
BEGIN
