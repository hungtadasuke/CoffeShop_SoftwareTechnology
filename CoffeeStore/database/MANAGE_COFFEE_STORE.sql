...
INSERT INTO BILL VALUES ('BL001', '2022/04/16', 0, 0, 0, 1, 'SF001','spot');

DELETE FROM BILL WHERE BILL_ID = 'BL002';

INSERT INTO DETAIL_BILL VALUES ('BL0011', 'BL001', 'TE001', 1, 30000,2, 'S', 'COLD');
